...
<head>
    ...
    <link rel="icon" href="<?php echo base_url();?>assets/img/cropped-kokoda_flavicon-32x32.png" sizes="32x32">
...
<nav class="navbar fixed-top flex-md-nowrap p-0 shadow top-main-nav">
    ...
    <ul class="navbar-nav px-3 ">
        ...
        <li class="nav-item text-nowrap">
            <a class="nav-link" href="<?php echo base_url('user/user_logout'); ?>">Log Out</a>
        </li>
    </ul>
</nav>
