...
<?php
/**
 * Template Name: Warranty Detail Template
 */
...
<div class="warranty-claim-panel">
    <div class="container-fluid">
        <div class="row">
            <div class="contact">
                <p>Lodge an online claim to our warranty department</p>
                <a href="<?php echo home_url(); ?>/warranty-claim"  target="_blank">Warranty Claim</a>
            </div>
        </div>
