<?php
if ( ! class_exists( 'SLP_Admin_Experience_Text' ) ) {
	/**
	 * Class SLP_Admin_Experience_Text
	 *
	 * Extend text for admin experience tab
	 *
	 * @package   StoreLocatorPlus\Admin\Experience\Text
	...
	class SLP_Admin_Experience_Text {
		...
		private function set_text_strings() {
			...
			$this->text_strings['description']['remove_credits'] =
				__( 'Remove the search provided by tagline under the map. ', 'store-locator-le' );

			$this->text_strings['description']['zoom_level'] =
			...
			$this->text_strings['description']['zoom_tweak'] =
