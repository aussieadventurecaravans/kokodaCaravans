<table class="form-table">
    <tbody>
    <tr>
    <td><label for="mailchimp">
			<input type="checkbox" name="options[mailchimp]" id="mailchimp" value="1" <?php checked( $values['mailchimp'], 1 ); ?> />
			<?php esc_html_e( 'Add users who submit this form to a Mailchimp mailing list', 'frmmlcmp' ) ?>
		</label>
	</td>
    </tr>
<?php
...
<p id="mlcmp_add_button" class="hide_mailchimp" style="margin-left:10px;<?php echo esc_attr( $values['mailchimp'] ? '' : 'display:none;' ); ?>">
    <a href="javascript:void(0)" class="button-secondary frm_mlcmp_add_list frm_add_logic_link">+ <?php esc_html_e( 'Add List', 'frmmlcmp' ) ?></a></p>
</p>
...
frm_form_id=<?php echo absint( $values['id'] ) ?>;
