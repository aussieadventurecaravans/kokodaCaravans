<div id="frm_mlcmp_group_select_<?php echo esc_attr( $list_id ) ?>_<?php echo esc_attr( $group['id'] ) ?>" class="frm_mlcmp_group_select">
<?php
    foreach ( $group['groups'] as $g ) { ?>
    <div>
        <label class="frm_left_label"><span class="frm_indent_opt"><?php echo esc_html($g['name']) ?></span></label>
        <p class="frm_show_selected_values_<?php echo esc_attr( $list_id . '_' . $group['id'] ); ?>" class="no_taglist">
        <?php 
            if ( isset($new_field) ) {
